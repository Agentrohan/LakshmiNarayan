...
import messages_get_1 from "./api/messages/GET";
import messages_post_2 from "./api/messages/POST";
import messages_id_patch_3 from "./api/messages/[id]/PATCH";
import profiles_get_4 from "./api/profiles/GET";
import profiles_post_5 from "./api/profiles/POST";
import profiles_id_delete_6 from "./api/profiles/[id]/DELETE";
import upload_photo_post_7 from "./api/upload-photo/POST";
// </api-imports>
...
app.get("/api/messages", messages_get_1);
app.post("/api/messages", messages_post_2);
app.patch("/api/messages/:id", messages_id_patch_3);
app.get("/api/profiles", profiles_get_4);
app.post("/api/profiles", profiles_post_5);
app.delete("/api/profiles/:id", profiles_id_delete_6);
app.post("/api/upload-photo", upload_photo_post_7);
// </api-registrations>
